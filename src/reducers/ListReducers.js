import { GET_LIST, ADD_LIST, ADD_LIST_LOCAL, UPDATE_ITEM, DELETE_ITEM, UPDATE_LIST_ITEM } from '../actions/types'
...
export default (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case UPDATE_ITEM:
            ...
            const elementsIndex = array.findIndex(x => x.id == updateObj.id);
            var finalArray = array[elementsIndex]

            return {
                ...state,
                itemToUpdate: finalArray
            }
